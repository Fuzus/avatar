...
public class HibernateCustomerRepository implements CustomerRepository {
    ...
    private Predicate[] condition(CustomerQuery query, CriteriaBuilder cb, Root<CustomerProfilePhotos> root) {
        return Stream.of(query.getIds().map(id -> cb.in(root.get("compositeKey").get("customerId")
                ).value(id)))
